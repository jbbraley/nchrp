...
% For LL and FC, resultCaseNum = vector of result case numbers that
% correspond to each responsevariable/location.
resultCaseNums = [29];
...
plateNums{1} = {[4888 4789 4690 4591 334 2710 2611 2512];[9145 9244 9343 136];[6670 6769 6868 1423 6967 7066 7165 7264]}; % mid M+1  6967   15
plateNums{2} = {[4294 4195 4096 3997 829 3898 3799 3700];[9442 9541 9640 1819];[7858 7957 8056 1621 8452 8551]};          % 2nd M+1  8452   17
plateNums{3} = {[3601 3502 3403 235 8848 8749];[433 10927 10828 10729 10630];[8650 1720]};                                % ext M+1  1720   12
plateNums{4} = {[4916 4817 4718 4619 362 2738 2639 2540];[9173 9272 9371 164];[6698 6797 6896 1451 6995 7094 7193 7292]}; % mid M-   6995    7
plateNums{5} = {[4322 4223 4124 4025 857 3926 3827 3728];[9470 9569 9668 1847];[7886 7985 8084 1649 8480 8579]};          % 2nd M-   8480    8
plateNums{6} = {[3629 3530 3431 263 8876 8777];[461 10955 10856 10757 10658];[8678 1748]};                                % ext M-   1748    5
plateNums{7} = {[4943 4844 4745 4646 389 2765 2666 2567];[9200 9299 9398 191];[6725 6824 6923 1478 7022 7121 7220 7319]}; % mid M+2  7022   16
plateNums{8} = {[4349 4250 4151 4052 884 3953 3854 3755];[9497 9596 9695 1874];[7912 8012 8111 1676 8507 8606]};          % 2nd M+2  8507   18
plateNums{9} = {[3656 3557 3458 290 8903 8804];[488 10982 10883 10784 10685];[8705 1775]};                                % ext M+2  1775   13
...
TopFlangePlateThickness = 8;
WebPlateLength = 13;
WebPlateThickness = 12;
BottomFlangePlateLength = 12;
BottomFlangePlateThickness = 7;

% Web Angle
intWebAngle = 0;
extWebAngle = atand(6/10);
...
for ii = 1:length(plateNums)
    ...
    TopFlangeY = 0.5*TopFlangePlateThickness + numWebPlates*WebPlateLength*cosd(webAngle) + BottomFlangePlateThickness;
    WebArea = numWebPlates*WebPlateLength*WebPlateThickness;
    WebY = numWebPlates*WebPlateLength*cosd(webAngle) + BottomFlangePlateThickness;
    ...
    yBar = (TopFlangeArea*TopFlangeY + WebArea*WebY + BottomFlangeArea*BottomFlangeY)...
        /(TopFlangeArea+WebArea+BottomFlangeArea);
